...
local function get_git_root()
    ...
    if not git_dir then
        return " " .. icons.git.unmerged .. " " .. icons.git.unstaged .. " "
    end

    local git_root = git_dir:gsub("/.git/?$", "")
    return get_basename(git_root) .. " " .. icons.git.unmerged .. " "
end
...
gls.left = {
    ...
    },
    {
        nvimGPS = {
            ...
            condition = function()
                return gps.is_available() and vim.bo.filetype ~= "NvimTree" and
                    check_buffer_and_width
            end,
